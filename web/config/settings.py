...
TWITCH_ONBOARD_STATE_TTL_SECONDS = int(
    os.getenv("TWITCH_ONBOARD_STATE_TTL_SECONDS", "600")
)
TWITCH_BROADCASTER_TOKEN_SCOPES = os.getenv(
    "TWITCH_BROADCASTER_TOKEN_SCOPES", "channel:bot"
)
TWITCH_GRANT_ENCRYPTION_KEY = os.getenv("TWITCH_GRANT_ENCRYPTION_KEY", "").strip()
